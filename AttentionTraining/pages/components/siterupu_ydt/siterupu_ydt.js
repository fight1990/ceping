// pages/components/siterupu_ydt/siterupu_ydt.js
...
Component({
    ...
    */
    ...
    startCircleTime: function(ctx) {    
      ...
      valHandle = setInterval(function(){
        ...
        if(step<=0){
          clearInterval(valHandle)  //销毁定时器
          that._readySiTeRuPuGame()
        }
      },100)
    },

    _readySiTeRuPuGame: function() {
      this.triggerEvent("readySiTeRuPuGame");
    },
  ...
  lifetimes: {
    ...
    ready:function() {
      siterupu_ctxtext = wx.createCanvasContext('siterupu_canvas_text', this)
