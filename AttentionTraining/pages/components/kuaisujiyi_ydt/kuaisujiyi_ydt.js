// pages/components/kuaisujiyi_ydt/kuaisujiyi_ydt.js

var api = require("../../../Api/api.js")
const util = require("../../../utils/util.js");
var ctxWave = wx.createCanvasContext('canvasArcCir', this)
var ctxGraph = wx.createCanvasContext('canvasgraph', this)
var ctxFlow = wx.createCanvasContext('canvasflow', this)
...
Component({
    ...
    */
    ...
    startCircleTime: function(ctx) {    
      ...
      valHandle = setInterval(function(){
        ...
        if(step<=0){
          clearInterval(valHandle)  //销毁定时器
          that._readyKuaiSuJiYiGame()
        }
      },100)
    },

    _readyKuaiSuJiYiGame: function() {
      this.triggerEvent("readyKuaiSuJiYiGame");
    },
  ...
  lifetimes: {
    ...
    ready:function() {
      ...
      ctxWave = wx.createCanvasContext('canvasArcCir', this)
      ctxGraph = wx.createCanvasContext('canvasgraph', this)
      ctxFlow = wx.createCanvasContext('canvasflow', this)
