...
#define KHWWaveFillColor [UIColor colorWithRed:168.0/255.0 green:231.0/255.0 blue:237.0/255.0 alpha:1.0f] //填充颜色
...
#define KHWWaveFont [UIFont boldSystemFontOfSize:65.0f]
...
- (UILabel *)cLabel {
    if (!_cLabel) {
        ...
        _cLabel.font = KHWWaveFont;
        _cLabel.textColor = KHWWaveColor;
...
- (void)setProgress:(CGFloat)progress {
    ...
    self.cLabel.text = [NSString stringWithFormat:@"%d", (int)ceil(_maxNumber * _progress)];    
}
