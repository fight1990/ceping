...
-(NSAttributedString *)attributedStringWithLineSpace:(CGFloat)lineSpace andWordSpace:(CGFloat)wordSpace andFont:(UIFont*)font{
    NSDictionary *dic = [self getAttributedDicWithLineSpace:lineSpace andWordSpace:wordSpace andFont:font];
...
-(NSDictionary*)getAttributedDicWithLineSpace:(CGFloat)lineSpace andWordSpace:(CGFloat)wordSpace andFont:(UIFont*)font{
